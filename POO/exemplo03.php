...
/*
$cpf = new Documento();
$cpf->setNumero('32735950867');

var_dump($cpf->getNumero());
*/

// para chamar metodo static a classe nao precisa ser instanciado pode se chamar direto

var_dump(Documento::validaCpf('324756926855'));
